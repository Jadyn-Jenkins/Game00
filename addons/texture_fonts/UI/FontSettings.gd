...
func _add_char_setting(char_setting_node = null, for_char = null):
	if char_setting_node == null:
		char_setting_node = char_setting_scene.instantiate()
	...
	char_setting_node.connect("change", Callable(self, "_value_changed"))
	char_setting_node.connect("delete", Callable(self, "_on_char_setting_delete"))
...
func _add_kerning_pair(kerning_pair_node = null, pair = null):
	if kerning_pair_node == null:
		kerning_pair_node = kerning_pair_scene.instantiate()
	...
	kerning_pair_node.connect("change", Callable(self, "_value_changed"))
	kerning_pair_node.connect("delete", Callable(self, "_on_kerning_pair_delete"))
