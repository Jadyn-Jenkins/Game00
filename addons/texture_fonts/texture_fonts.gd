...
func handles(object: Object) -> bool:
	if object is FontFile and object.get_class() == "TextureFont":
		return true
...
func edit(object: Object):
	var resoruce: FontFile = object as FontFile
...
func open_editor(font: Object):
	...
	if not is_instance_valid(_font_editor):
		...
		add_control_to_bottom_panel(_font_editor, "Texture2D Font")
		_font_editor.connect("close", Callable(self, "close_editor"))
